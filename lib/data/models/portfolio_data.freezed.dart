...
switch (_that) {
case _Project() when $default != null:
return $default(_that.id,_that.slug,_that.isSample,_that.categories,_that.status,_that.year,_that.featured,_that.isVisible,_that.sortOrder,_that.title,_that.role,_that.client,_that.shortDescription,_that.fullDescription,_that.problem,_that.solution,_that.responsibilities,_that.features,_that.challenges,_that.results,_that.lessonsLearned,_that.technologies,_that.platforms,_that.tags,_that.thumbnailImage,_that.coverImage,_that.gallery,_that.links);case _:
  return orElse();
