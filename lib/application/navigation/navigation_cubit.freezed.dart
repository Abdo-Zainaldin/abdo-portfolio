...
mixin _$NavigationState {
 ...
 PortfolioSection get activeSection;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NavigationState&&(identical(other.activeSection, activeSection) || other.activeSection == activeSection));
}


@override
int get hashCode => Object.hash(runtimeType,activeSection);

@override
String toString() {
  return 'NavigationState(activeSection: $activeSection)';
}
...
/// Create a copy of NavigationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? activeSection = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PortfolioSection activeSection)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NavigationState() when $default != null:
return $default(_that.activeSection);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PortfolioSection activeSection)  $default,) {final _that = this;
switch (_that) {
case _NavigationState():
return $default(_that.activeSection);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PortfolioSection activeSection)?  $default,) {final _that = this;
switch (_that) {
case _NavigationState() when $default != null:
return $default(_that.activeSection);case _:
  return null;
...
class _NavigationState implements NavigationState {
  const _NavigationState({this.activeSection = PortfolioSection.home});
  

@override@JsonKey() final  PortfolioSection activeSection;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NavigationState&&(identical(other.activeSection, activeSection) || other.activeSection == activeSection));
}
...
/// Create a copy of NavigationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? activeSection = null,}) {
